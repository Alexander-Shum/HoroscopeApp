...
import com.alex.horoscopeapp.ui.horoscope.HoroscopeFragment;
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                  AppCompatActivity activity = (AppCompatActivity) view.getContext();
                    ShowHoroscope showHoroscope = new ShowHoroscope();
                    HoroscopeFragment horoscopeFragment = new HoroscopeFragment();


                    activity.getSupportFragmentManager().beginTransaction().replace(R.id.container, showHoroscope).addToBackStack("tag").commit();
                    activity.getSupportFragmentManager().beginTransaction().remove(horoscopeFragment);
                    Bundle bundle = new Bundle();
                    bundle.putString("zodiacName", zodiacName.getText().toString());
                    showHoroscope.setArguments(bundle);
